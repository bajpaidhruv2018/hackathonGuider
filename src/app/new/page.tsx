...
export default function NewProjectPage() {
  ...
  const canProceed = projectName.trim() && duration.trim() && members.some(m => m.name.trim());
    ...
    try {
      ...
      const concept = {
        ...
        metadata: {
          ...
          time_remaining: duration === "custom" ? "Custom Window" : `${duration} Hours`,
          start_time: new Date().toISOString(),
          end_time: duration !== "custom" ? new Date(Date.now() + parseInt(duration) * 3600 * 1000).toISOString() : null,
      ...
      <div className="relative z-10 w-full max-w-[1024px] mx-auto px-lg mt-xl flex flex-col gap-xl">
        ...
        <div className="mt-lg flex justify-end">
          ...
          >
            ...
            {isSubmitting ? 'INITIALIZING MISSION...' : 'GENERATE MISSION ROADMAP'}
